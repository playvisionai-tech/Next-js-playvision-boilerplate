...
# Firebase Analytics + Remote Config. NEXT_PUBLIC_* is inlined at build time,
# so an image built without these ships with Firebase silently disabled rather
# than failing. Empty defaults keep an unconfigured build working.
